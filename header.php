...
<div class="brandband d-flex">
	...
	<header id="wrapper-head" class="position-relative" itemscope itemtype="http://schema.org/WebSite">
		...
		<a class="skip-link screen-reader-text sr-only" href="#content"><?php esc_html_e( 'Skip to content', 'understrap' ); ?></a>
                <div class="col-4 px-0 my-4 d-none d-lg-block"><a class="site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php get_template_part( 'partials/dyn', 'logo' ); ?> </a></div>
                                <!-- end custom logo -->
