<div class="<?php the_cc_css_classes( 'content_cards_card card' ); ?>">
    <?php if ( get_cc_data( 'image' ) ) : ?>
        ...
        <?php endif; ?>
            <div class="content_cards_title"> <a class="content_cards_title_link" href="<?php the_cc_data( 'url', 'esc_url' ); ?>" <?php the_cc_target(); ?>>
			<?php the_cc_data( 'title' ); ?>
		</a> </div>
            <div class="content_cards_description"> <a class="content_cards_description_link" href="<?php the_cc_data( 'url', 'esc_url' ); ?>" <?php the_cc_target(); ?>>
